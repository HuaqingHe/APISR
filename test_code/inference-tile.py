...
if __name__ == "__main__":
    ...
    store_dir = os.path.join(store_dir, model)
    ...
    def inner_loop(process_dir):
        ...
        if input_extension in supported_img_extension: # If the input path is single image
            output_path = os.path.join(store_dir, filename+".png")      # Output fixed to be png
            ...
            output_path = os.path.join(store_dir, filename+".mp4")      # Output fixed to be mp4
